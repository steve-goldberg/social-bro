...
async function GET() {
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userSettings.findUnique({
            where: {
                userId
            }
        });
...
async function POST(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userSettings.upsert({
            where: {
                userId
            },
            update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3c67487._.js.map